...
#gfdl
FFLAGS_PROD = -O3 -debug minimal -fp-model source
...
FFLAGS += $(FFLAGS_REPRO)
COBALT = $(FFLAGS)
#-fpp -Wp,-w -fno-alias -auto -safe-cray-ptr -ftz -assume byterecl -i4 -r8 -nowarn -sox -traceback -O2 -debug minimal -fp-model source -msse2 
...
FFLAGS += $(FFLAGS_PROD)
COBALT = $(FFLAGS)
#-fpp -Wp,-w -fno-alias -auto -safe-cray-ptr -ftz -assume byterecl -i4 -r8 -nowarn -sox -traceback -O3 -debug minimal -fp-model source -msse2
endif
